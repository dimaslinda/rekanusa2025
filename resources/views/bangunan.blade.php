...
@section('content')
    ...
    {{-- mobile --}}
    <section id="tentang"
        class="relative block lg:hidden bg-[url('../../public/img/general/service-konstruksi.webp')] bg-no-repeat bg-cover bg-center bg-blend-overlay bg-white/60 h-auto">
    ...
    {{-- section perolehan --}}
    <section id="profil"
        class="relative lg:min-h-[90vh] bg-white lg:bg-[url('../../public/img/general/bg-perolehan-bangunan.webp')] bg-no-repeat bg-cover bg-center">
